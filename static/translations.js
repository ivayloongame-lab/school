/**
 * Multi-language translations for Shkolo
...
const translations = {
  en: {
    ...
    // Index
    welcomeToShkolo: "Welcome to Shkolo",
    yourLearningDestination: "Your learning destination",
    aboutThisWebsite: "About This Website",
    createdBy: "Created by Ivaylo Terziev",
    comprehensiveSchoolManagement: "Welcome to Shkolo - A comprehensive School Management System",
  ...
  bg: {
    ...
    // Начало
    welcomeToShkolo: "Добро пожаловать в Shkolo",
    yourLearningDestination: "Вашата дестинация за обучение",
    aboutThisWebsite: "За този уебсайт",
    createdBy: "Създано от Ivaylo Terziev",
    comprehensiveSchoolManagement: "Добро пожаловать в Shkolo - Комплексна система за управление на училище",
